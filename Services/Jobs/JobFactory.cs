...
{
    /// <summary>
    /// This is the main JobFactory method. It runs periodically. It receives the worker schedules.
    ...
    {
        public static string JobName = "JobFactory";
        public static string JobGroup = "JobFactoryGroup";
        public static string TriggerName = "JobFactoryTrigger";
        public static string TriggerGroup = "JobFactoryTriggerGroup";
        ...
        public Task Execute(IJobExecutionContext context)
        {
            try
            {
                //Console.WriteLine($"Running JobFactory Job {RandomId} at " + DateTime.Now.ToString());
                var triggerTime = AppSettings.GetValue(AppSettings.JobFactoryTriggerTime);
                //Console.WriteLine($"Current JobFactory trigger time: {triggerTime}");
            ...
            {
                Console.WriteLine("Received an error when executing JobFactory job. " + e.Message);
